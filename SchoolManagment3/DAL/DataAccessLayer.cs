...
namespace SchoolManagment3.DAL
{
    class DataAccessLayer
    {
      //  public static string stri = ConfigurationManager.ConnectionStrings["partialConnectString"].ToString();
        public static string con = @"Data Source =(LocalDB)\MSSQLLocalDB;AttachDbFilename= C:\PROGRAM FILES\MICROSOFT SQL SERVER\MSSQL10.SQLEXPRESS\MSSQL\DATA\schoolmanagment2017.mdf; Integrated Security=True";
